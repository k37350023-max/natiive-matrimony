  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', background: '#F8F7F5' }}>
      <div style={{ textAlign: 'center', maxWidth: '380px' }}>
        <p className="font-serif-display" style={{ fontSize: '100px', fontWeight: 700, color: '#F0EDE8', lineHeight: 1, margin: '0 0 20px' }}>404</p>
        <h1 style={{ fontSize: '22px', fontWeight: 700, color: '#0F0F0F', margin: '0 0 10px', letterSpacing: '-0.02em' }}>Page not found</h1>
        <p style={{ fontSize: '14px', color: '#9CA3AF', margin: '0 0 28px', lineHeight: 1.6 }}>This page doesn&apos;t exist or was moved.</p>
