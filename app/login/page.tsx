  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#F9FAFB' }}>
      ...
      <div className="flex-1 flex">
        ...
        <div className="hidden lg:flex flex-col justify-center px-16 flex-1" style={{ background: 'white', borderRight: '1px solid #E5E7EB' }}>
          <div className="max-w-sm">
            <p className="text-xs font-semibold uppercase tracking-widest mb-5" style={{ color: '#9B1C1C' }}>NatiiveMatrimony</p>
            <h2 className="font-serif-display text-3xl font-bold text-gray-900 leading-snug mb-6">
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={f.title} className="flex gap-3.5">
                  <div className="w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5" style={{ background: '#FEF2F2' }}>
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#9B1C1C" strokeWidth="3">
        ...
        <div className="flex-1 flex items-center justify-center px-5 py-12">
          <div className="w-full max-w-sm">
            <div className="mb-7">
              <h1 className="text-2xl font-bold text-gray-900 font-serif-display">Welcome back</h1>
              <p className="text-sm text-gray-500 mt-1">Sign in to browse your matches</p>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <Link href="/forgot-password" className="text-xs font-medium" style={{ color: '#9B1C1C' }}>
                      Forgot password?
                    </Link>
                  </div>
            ...
            <p className="text-center text-sm text-gray-500 mt-5">
              No account yet?{' '}
              <Link href="/register" className="font-semibold" style={{ color: '#9B1C1C' }}>Register free</Link>
            </p>
          </div>
        </div>
      </div>
