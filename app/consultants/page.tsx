      ...
      <div className="landing-shell">
        ...
        <section className="consultant-card" style={{ alignItems: 'center' }}>
          <div className="consultant-copy">
            ...
            <p>For families who want more than software, NativeMatrimony.com can coordinate vetted introductions, shortlist review, and next-step guidance while private contact is shown only after acceptance.</p>
