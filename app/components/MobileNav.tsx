...
export default function MobileNav() {
  ...
  const items = [
    ...
    {
      href: '/interests', label: 'Connect', active: path.startsWith('/interests'), badge: pendingInterests,
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    {
      href: '/matches', label: 'Messages', active: inboxActive, badge: unreadMessages,
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
