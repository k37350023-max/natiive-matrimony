      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '20px 16px' }}>
        ...
        <div style={{ background: 'white', borderRadius: '10px', border: '1px solid #E8E8E8', overflow: 'hidden', marginBottom: '14px' }}>
          {[
            ...
            { label: 'Connected Profiles', sub: 'View contact, WhatsApp, and optional chat.', href: '/matches' },
          ...
          <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ fontSize: '12.5px', color: '#94A3B8', margin: '0 0 10px', lineHeight: 1.5 }}>
                {pct >= 90
                  ? 'Your profile is ready for families to review.'
                  : `Add missing details so families can understand your profile.`}
              </p>
              {missing.length > 0 && (
        ...
        <div style={{ background: 'white', borderRadius: '10px', border: '1px solid #E8E8E8', overflow: 'hidden' }}>
          {[
            ...
            { icon: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/>', label: 'View my profile', href: `/profile/${profile.id}` },
          ].map((item, i, arr) => (
            <Link key={item.label} href={item.href} style={{
