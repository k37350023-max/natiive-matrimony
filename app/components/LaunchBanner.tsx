...
export default function LaunchBanner() {
  ...
  return (
    <Link href={isLoggedIn ? '/pricing' : '/register'}
      ...
      style={{ background: 'linear-gradient(135deg, #7C2D12 0%, #92400E 50%, #B45309 100%)' }}>
      <div className="px-5 py-5 flex items-center gap-5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-amber-200 text-xs mt-0.5 leading-snug">
          ...
          {count !== null && (
            <div className="mt-2 flex items-center gap-2">
              ...
              <span className="text-[10px] font-semibold text-amber-300 shrink-0">{remaining.toLocaleString()} left</span>
            </div>
          )}
        </div>
        ...
        <div className="shrink-0 flex flex-col items-end gap-2">
          <span className="text-xs font-bold px-3 py-1.5 rounded-lg"
            style={{ background: '#FEF9EC', color: '#7C2D12' }}>
